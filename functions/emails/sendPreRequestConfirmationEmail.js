...
const sendEmailPreRequestConfirmation = functions.firestore
  .document("reservations/{reservationId}")
  .onCreate(async (snap, context) => {
    const reservationData = snap.data();
    const reservationId = context.params.reservationId;

    // Vérifier les conditions pour l'envoi de l'email
    if (
      reservationData.bookingStatus !== "pré-demande" ||
      reservationData.reservationType !== "petits-travaux"
    ) {
      console.log(
        `Skipping email for reservationId: ${reservationId} as it does not meet pre-request criteria.`
      );
      return;
    }
...
<head>
  <title> Confirmation de Pré-Demande </title>
  <!--[if !mso]><!-->
...
<body style="word-spacing:normal;background-color:#ffffff;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Confirmation de votre pré-demande pour le service de petits travaux </div>
  <div style="background-color:#ffffff;">
    <!-- Logo Sahel en dehors de l'encadré -->
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#333333;">Pré-Demande Enregistrée</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#666666;">Bonjour ${reservationData.firstName}, <br /><br /> Nous vous confirmons que votre pré-demande pour notre service de <strong>petits travaux</strong> a bien été enregistrée. Cette étape nous permet de vérifier les détails de votre demande afin de nous assurer que toutes les informations nécessaires sont en notre possession. <br /><br /> Notre équipe reviendra vers vous pour la suite du processus. Si nous avons besoin de précisions supplémentaires, nous vous contacterons directement dans votre espace de messagerie. <br /><br /> Merci de votre confiance, <br /> L'équipe Sahel</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
    ...
    <!--[if mso | IE]></td></tr></table><![endif]-->
    <!-- Icônes des réseaux sociaux en dehors de l'encadré -->
    <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:600px;" width="600" bgcolor="#ffffff" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;background-color:#ffffff;width:100%;">
        <tbody>
    ...
    <!--[if mso | IE]></td></tr></table><![endif]-->
      ...
      try {
        console.log(
          `Sending pre-request confirmation email to: ${reservationData.email}`
        );
        await apiInstance.sendTransacEmail(sendSmtpEmail);
        console.log("Pre-request confirmation email sent successfully");
        ...
        await admin
          ...
          .doc(reservationId)
          .update({
            "emails.preRequestEmailSent": true,
          });
        console.log(
          `Updated reservationId: ${reservationId} with preRequestEmailSent: true`
        );
      } catch (error) {
        console.error("Failed to send pre-request confirmation email:", error);
      }
    } else {
      console.log(
        `Pre-request confirmation email already sent for reservationId: ${reservationId}`
      );
    }
  });

module.exports = { sendEmailPreRequestConfirmation };
